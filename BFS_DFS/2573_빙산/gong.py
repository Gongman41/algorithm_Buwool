    ...
    for i in range(1,N-1):
        for j in range(1,M-1):
            ...
            while stack:
                count = 0
                star = stack.popleft()
                viewed[star[0]][star[1]] += 1
                
                for n in range(4):
                    if 0 <= star[0] + dr_r[n] < N and 0 <= star[1] +dr_c[n] < M and matrix[star[0] + dr_r[n]][star[1] + dr_c[n]] > 0 and 0 <=viewed[star[0] + dr_r[n]][star[1] + dr_c[n]] < year +1:
